...
# Download current GPS TLEs from Celestrak and save to file
...
# Print summary
print(f" {len(gps_states_synced)} GPS propagated successfully")
print(f" {len(filtered_satellites) - len(gps_states_synced)} GPS failed to propagate")
