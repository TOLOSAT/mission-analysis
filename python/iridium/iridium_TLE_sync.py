...
target_datetime = datetime.datetime(target_year, 1, 1, 0, 0, 0) + datetime.timedelta(days=target_day - 1)
target_jd, target_fr = jday(target_datetime.year, target_datetime.month, target_datetime.day, target_datetime.hour,
                            target_datetime.minute, target_datetime.second)
...
for i in tqdm(range(len(TLEs)), desc="Syncing TLEs", ncols=80, total=len(TLEs)):
    ...
    iridium_states_synced.append(dict(
