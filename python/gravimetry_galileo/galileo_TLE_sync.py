...
# Download current Galileo TLEs from Celestrak and save to file
...
# Filter TLEs no older than 5 days
filtered_satellites = []
...
print(f"\n{len(filtered_satellites)} Galileo TLEs passed age filtering.")
...
# Print summary
print(f" {len(galileo_states_synced)} Galileo satellites propagated successfully")
print(f" {len(filtered_satellites) - len(galileo_states_synced)} Galileo satellites failed to propagate")
