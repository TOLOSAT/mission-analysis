...
from useful_functions.filter_functions import filter_data
...
filtered_visibility, filtered_galileo_sat_results, filtered_windows = filter_data(galileo_visibility_path, galileo_windows_path,galileo_sat_results_path,start_date, end_date)
