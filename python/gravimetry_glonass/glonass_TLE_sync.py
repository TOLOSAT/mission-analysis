...
TLEs_text = get(glonass_url).text
...
# Sync glonass satellites
glonass_states_synced = []
...
glonass_states_synced = pd.DataFrame(glonass_states_synced)
glonass_names = glonass_states_synced["name"].to_list()
