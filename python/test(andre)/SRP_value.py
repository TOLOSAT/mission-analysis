...
SolarRadiationPressure = 1367/3e8 * radiation_pressure_coefficient * 1 * (np.cos(0))**2
print('Solar Radiation Pressure experienced by the satellite is ' + str(SolarRadiationPressure) + " Pa")
...
#radiation pressure on the satellite